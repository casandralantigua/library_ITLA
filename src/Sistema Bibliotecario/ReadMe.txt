========================================================================
    APLICACIÓN DE CONSOLA: Sistema Bibliotecario Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Sistema Bibliotecario.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Sistema Bibliotecario.


Sistema Bibliotecario.vcxproj
...
Sistema Bibliotecario.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Sistema Bibliotecario.pch y un archivo de tipos precompilados llamado StdAfx.obj.
